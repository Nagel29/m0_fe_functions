...
function printJobInfo(coName, min, max) {
  var payRange = max - min;
  console.log(`${coName}, pay range: $${payRange}`);
}

printJobInfo("ABC Company", 75000, 125000);

// 4: Write a function that satifies the following interaction pattern:
function checkStock(quantity, inventory) {
  if (quantity === 4) {
    console.log(`${inventory} is stocked`);
  }
  if (quantity === 3) {
